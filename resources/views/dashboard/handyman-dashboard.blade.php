                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="d-flex flex-wrap justify-content-start align-items-center">
                                            <h5 class="mb-2 font-weight-bold text-primary dashboard-card-value">{{ !empty($data['dashboard']['count_total_booking']) ? $data['dashboard']['count_total_booking']: 0 }} </h5>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col">
                                            <div class="d-flex flex-wrap justify-content-start align-items-center">
                                                <h5 class="mb-2 font-weight-bold text-primary dashboard-card-value">{{ !empty($data['dashboard']['count_handyman_pending_booking']) ? $data['dashboard']['count_handyman_pending_booking'] : 0 }}</h5>
                                                <p class="mb-0 ml-3 text-success font-weight-bold"></p>
                                            </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col">
                                        <div class="d-flex flex-wrap justify-content-start align-items-center">
                                            <h5 class="mb-2 font-weight-bold text-primary dashboard-card-value">{{ !empty($data['dashboard']['count_handyman_complete_booking']) ? $data['dashboard']['count_handyman_complete_booking'] : 0 }}</h5>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col">
                                        <div class="d-flex flex-wrap justify-content-start align-items-center">
                                            <h5 class="mb-2 font-weight-bold text-primary dashboard-card-value">{{ !empty($data['dashboard']['count_handyman_cancelled_booking']) ? $data['dashboard']['count_handyman_cancelled_booking'] : 0 }}</h5>
                                            <p class="mb-0 ml-3 text-danger font-weight-bold"></p>
                                        </div>
                                        <p class="mb-0 text-secondary">{{ __('messages.cancelled', ['name' => __('messages.booking')]) }}</p>
                                    </div>
                                    <div class="col-auto d-flex flex-column">
