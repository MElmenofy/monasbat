                ...
                <div class="card card-block card-stretch">
                    <div class="card-body p-0">
                        <div class="d-flex justify-content-between align-items-center p-3">
                            <h5 class="font-weight-bold">{{ trans('messages.add_new_cat') }}</h5>
                            ...
                            <div class="row">
                                ...
                                @if(getMediaFileExit($categorydata, 'category_image'))
                                    <div class="col-md-2 mb-2">
                                        ...
                                        @endphp
{{--                                        {{ asset('assets/products/' . $product->firstMedia->file_name) }}--}}
                                        <!--<img id="category_image_preview" src="{{ asset('storage').'/' .$media->model_id .'/'. $media->file_name }}" alt="#" class="attachment-image mt-1" style="background-color:{{ $extention == 'svg' ? $categorydata->color : '' }}">-->
{{--                                        <img id="category_image_preview" src="{{ storage_path('/1/Webp.net-resizeimage-(1).png') }}" alt="#" class="attachment-image mt-1" style="background-color:{{ $extention == 'svg' ? $categorydata->color : '' }}">--}}
