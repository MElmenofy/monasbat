        ...
        <div class="col-lg-8">
          <div class="service-detail-box">
            <div class="service-image">
                <img v-if="serviceData.attchment_extension == true" :src="serviceData.attchments[0]" alt="image" class="img-fluid rounded">
  ...
  >
      ...
      <div class="modal-body">
        ...
        <div class="coupon-inner">
            <p>{{__('messages.available_coupon')}}</p>
            ...
            <div class="d-grid mt-5">
                <button type="submit" class="btn btn-primary btn-block" @click="addCoupon">{{__('messages.submit')}}</button>
                <button type="submit" class="btn btn-outline-primary btn-cancel btn-block mt-4">{{__('messages.cancel')}}</button>
            </div>     
        </div>
      </div>    
  </b-modal>
