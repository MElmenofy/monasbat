          ...
          <div class="service-detail-box">
            ...
            <div class="service-meta">
              <ul class="list-inline d-flex flex-wrap align-items-center">
                <li>
                   <span class="list-label heading-color heading-weight">{{__('messages.booking_status')}} :</span><span class="list-value"> {{bookingDetail.status}}</span>
                </li>
                <li>
                  <span class="list-label heading-color heading-weight">{{__('messages.payment_status')}} :</span><span class="list-value"> {{bookingDetail.payment_status ? bookingDetail.payment_status : __('messages.pending')}}</span>
                </li>
                <li class="d-flex align-items-center">
                    <span class="list-label heading-color heading-weight">{{__('messages. ')}}</span><span class="list-value"> 
