...
class User extends Authenticatable implements HasMedia
{
    ...
    protected $fillable = [
        ...
        'player_id','country_id', 'state_id',  'city_id' , 'address', 'provider_id' , 'handyman_id' , 'status', 'display_name', 'providertype_id' , 'is_featured' , 'time_zone' ,'last_notification_seen' , 'login_type','service_address_id' , 'uid'
    ];
...
//    hand
    ...
    public function coupons(){
        return $this->hasMany(CouponProduct::Class, 'provider_id', 'id');
    }
}
