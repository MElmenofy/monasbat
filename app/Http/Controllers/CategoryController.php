...
//        $media = DB::table('media')->where('model_id', $categorydata->id)->value('file_name');
        $media = DB::table('media')->where('model_id', $categorydata->id)->first();

//        return $media->file_name. $media->model_id;

        return view('category.create', compact('pageTitle' ,'categorydata' ,'auth_user', 'media' ));
    }
