...
//        $da = json_decode($handymandata->provider_id);
//        return $da;
//        return $handymandata->provider_id[0];
...
//        $e = $request->handyman_id;
//        $array = str_split($e, 1);
//        $request['handyman_id'] = $array;
        $data = $request->all();
        ...
        if ($request->city_id){
            $titles = City::findOrFail($request->city_id);
            $c_n =  $titles->name;
            $data['address'] = $c_n;
        }
        // return $data;
