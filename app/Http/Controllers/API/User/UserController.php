...
//            $last_id = $u->id;
    ...
    {
        // $user_type = isset($request['user_type']) ? $request['user_type'] : 'provider';

        // $handyman_list = User::with('hand')->where('user_type',$user_type);
        ...
        if($request->has('id'))
        {
            $handyman_list = $handyman_list->where('id',$request->id);
            // $handyman_list = User::with('hand')->where('id', 10)->first();
        }

        // if($request->provider_id == 10)
        // {
        //     $handyman_list = $handyman_list->where('handyman_id',$request->handyman_id);
        // }
        //
