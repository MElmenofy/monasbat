...
class HandymanDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->editColumn('handyman_id', function($provider) {
                return ($provider->handyman_id != null && isset($provider->handyman_id)) ? $provider->hand->display_name : '-';
            })
//

//            ->editColumn('provider_id', function($handyman) {
//                return ($handyman->provider_id != null && isset($handyman->provider_id)) ? $handyman->providers->display_name : '-';
//            })
...
//            $model = $model->whereNotNull('provider_id');
            $model = $model->with('providers')->whereUserType('handyman');
        }
        return $model;
